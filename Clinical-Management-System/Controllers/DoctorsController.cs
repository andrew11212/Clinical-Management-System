...
namespace Clinical_Management_System.Controllers
{
    public class DoctorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DoctorId,Photo,NationalId,UserName,Password,FirstName,LastName,City,BuildingNum,StreetName,Government,Floor,SpecializationId")] Doctor doctor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DoctorId,Photo,NationalId,UserName,Password,FirstName,LastName,City,BuildingNum,StreetName,Government,Floor,SpecializationId")] Doctor doctor)
        {
